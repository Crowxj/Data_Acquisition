...
function ndac_mode1_display_TD(id,d1) {
    ...
    //3.在ndac_foursections_Page.html界面显示第一条TD值
    showStatus(`>>> ${getTimestamp()} 设备号：${ndac_mode1_device_num}  DSP IP：${ndac_mode1_dspip_num}  CANFD：${ndac_mode1_canfd_num}  端口：${ndac_mode1_port}  模式：${ndac_mode1_mode}`);
}